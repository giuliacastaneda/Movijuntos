...
Descrição : O usuário visitou um restaurante e deseja compartilhar sua experiência quanto a acessibilidade do local
| **Usuário**  | **Acessar o site e realizar login** | **Selecionar o local no mapa** | **Atribuir nota e especificações de acessibilidade** (Sim/Não) | **Escrever um comentário** | *Fazer upload de até 3 fotos e enviar** |
|-------------|--------------------|---------------------------------|-----------------|------------------------|------------------------------|
| Usuário 1   |Possível ver apenas a tela Avaliacao| Não implementado| Sim | Recurso incompleto|Possível selecionar mas não envia ( em implementação)|                     |      
| Usuário 2   |Possível ver apenas a tela Avaliacao| Não implementado| Sim | Recurso incompleto|Possível selecionar mas não envia ( em implementação)|                     |       
| Usuário 3   |Possível ver apenas a tela Avaliacao| Não implementado| Sim | Recurso incompleto|Possível selecionar mas não envia ( em implementação)|                     |    
| Usuário 4   |Possível ver apenas a tela Avaliacao| Não implementado| Sim | Recurso incompleto|Possível selecionar mas não envia ( em implementação)|                     |   
| Usuário 5   |Possível ver apenas a tela Avaliacao| Não implementado| Sim | Recurso incompleto|Possível selecionar mas não envia ( em implementação)|                     |   
