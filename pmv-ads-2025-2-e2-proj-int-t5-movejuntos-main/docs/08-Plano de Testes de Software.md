...
| Responsável pela elaboração do caso de Teste | Gabriel Fernando |       
...
| Responsável pela elaboração do caso de Teste | João Victor  |     
...
| Responsável pela elaboração do caso de Teste | Giulia Castañeda  |
<hr>
...
| Responsável pela elaboração do caso de Teste |Vinícius Claret |
<hr>
...
| Caso de Teste                                | CT-RF-007 - Verificar cadastro de comentários                                                                                                                         |
|---------------|----------------------------------------------------|
| Requisitos Associados                        | RF-007: A aplicação deve permitir cadastro de comentários durante a avaliação do local.   |
| Objetivo do Teste                            | Garantir que comentários possam ser inseridos durante avaliação.                                                                                                                  |
| Passos                                       | 1) Acessar o Navegador. <br> 2) Informar o endereço do Site. <br> 3) Realizar login. <br> 4) Selecionar um local cadastrado. <br> 5) Acessar opção "Avaliações". <br> 6) Inserir avaliação com comentário e salvar.|
| Critérios de êxito                           | O sistema deve exibir o comentário registrado durante avaliação do local.                                                                                                 |
| Responsável pela elaboração do caso de Teste | Gustavo Henrique  |
<hr>
...
| Caso de Teste                                | CT-RF-010 - Verificar FAQ    |
|---------------|----------------------------------------------------|
| Requisitos Associados                        | RF-010: A aplicação deve possuir um FAQ para que o usuário possa retirar suas dúvidas.    |
| Objetivo do Teste                            | Validar a funcionalidade da FAQ.   |
| Passos                                       | 1) Acessar o Navegador. <br> 2) Informar o endereço do Site. <br> 3) Acessar Pop-up no canto inferior da tela. <br> 4) Selecionar "Ajuda". |
| Critérios de êxito                           | O sistema deve permitir acesso a uma FAQ para o usuário retirar as dúvidas que houverem. |
| Responsável pela elaboração do caso de Teste | Gabriel Fernando   |
<hr>
...
| Caso de Teste                                | CT-RF-013 -  A aplicação deve exibir um relatório da busca de locais realizada pelo usuário	  |
|---------------|----------------------------------------------------|
| Requisitos Associados                        | RF-013: A aplicação deve exibir um relatório da busca de locais realizada pelo usuário.          |
| Objetivo do Teste                            | Validar se a busca retorna relatório com locais referentes aos termos solicitados.                      |
| Passos                                       | 1) Acessar o Navegador. <br> 2) Informar o endereço do Site. <br> 3) Acessar tela de busca. <br> 4) Inserir termos para busca de locais no espaço especificado na tela . <br> 5) Confirmar pesquisa. |
| Critérios de êxito                           | O sistema deve exibir um relatório de locais com termos associados a procura inserida. |
| Responsável pela elaboração do caso de Teste | Giulia Castañeda         |
<hr>
...
|---------------|---------------------------------------------------------|
| **Requisitos Associados** | RNF-002: A aplicação deve ser compatível com navegadores (Chrome, Opera, Edge) |
| **Objetivo do Teste** | Validar se a aplicação funciona corretamente nos principais navegadores. |
| **Passos** | 1) Acessar a aplicação no Chrome. <br> 2) Acessar a aplicação no Opera. <br> 3) Acessar a aplicação no Edge. |
| **Critérios de Êxito** | Todas as páginas do site devem carregar em todos navegadores testados. |
| **Responsável pela elaboração do caso de Teste** | Gustavo Henrique  |
<hr>
...
| **Passos** | 1) Acessar o Navegador. <br> 2) Informar o endereço do Site. <br> 3) Realizar cadastro <br> 4) Realizar login. <br> 5) Realizar fluxo de busca de local. <br> 6) Realizar cadastro de local. <br> 7) Avaliar um local. <br> 8) Avaliar quantidade de cliques necessários para cada funcionalidade. |
...
| **Passos** | 1) Acessar o Navegador. <br> 2) Informar o endereço do Site. <br> 3) Acessar funcionalidade de mapa. <br> 4) Medir tempo de carregamento até exibição completa ao menos 30x. <br> 5) Calcular média de tempo de carregamento                |
| **Critérios de Êxito** | O tempo de carregamento médio não deve ultrapassar 15 segundos. |
| **Responsável pela elaboração do caso de Teste** |  João Victor |
<hr>
...
| **Responsável pela elaboração do caso de Teste** | Vinicius Claret |
<hr>
