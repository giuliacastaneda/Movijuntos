...
namespace Web_App_Movijuntos.Controllers
{
    public class LocaisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdLocal,Nome,Endereco")] Local local)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdLocal,Nome,Endereco")] Local local)
        {
            if (id != local.IdLocal)
            {
                return NotFound();
