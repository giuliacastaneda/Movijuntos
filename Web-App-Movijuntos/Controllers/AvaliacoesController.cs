...
namespace Web_App_Movijuntos.Controllers
{
    public class AvaliacoesController : Controller
    {
        ...
        {
            var appDbContext = _context.Avaliacoes.Include(a => a.Local);
        ...
        public async Task<IActionResult> Create([Bind("IdAvaliacao,Data,Nota,IdLocal")] Avaliacao avaliacao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAvaliacao,Data,Nota,IdLocal")] Avaliacao avaliacao)
        {
